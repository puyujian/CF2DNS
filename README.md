...
### ��¼�뻷����������
- ������ѡ��̨��¼���������û������� `ADMIN_PASSWORD` ������ `/api/*` ������Ҫ��ͨ�� `/api/auth/login` ��¼��ǰ�����Ͻ��ṩ����¼����ڣ������յ� 401 ʱ�Զ�������
- ��������ʾ��������¼����
```
docker run --rm -p 3000:3000 \
  -e CLOUDFLARE_API_TOKEN=���Token \
  -e ADMIN_PASSWORD=��ĺ�̨���� \
  ghcr.io/puyujian/cf2dns:latest
```
- �ű�ʾ����
  - Bash: `CLOUDFLARE_API_TOKEN=���Token ADMIN_PASSWORD=��ĺ�̨���� ./docker-run.sh`
  - PowerShell: `./docker-run.ps1 -Token ���Token -AdminPassword ��ĺ�̨����`
- ������Ҫ��¼�������ɲ����� `ADMIN_PASSWORD`���� `CLOUDFLARE_API_TOKEN` ��Ϊ���裬����ǰ�˻���ʾ����������ʧ�ܡ���
